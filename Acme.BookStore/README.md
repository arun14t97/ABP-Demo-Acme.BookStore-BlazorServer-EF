...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p ae37ec78-9055-40bc-be1d-342df31527a6
```

> `ae37ec78-9055-40bc-be1d-342df31527a6` is the password of the certificate, you can change it to any password you want.
